...
const EditQuizInfoDialog = ({
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="flex max-h-dvh w-[90%] flex-col sm:w-[80%]">
        <DialogHeader>
        ...
        <div className="max-h-dvh overflow-auto">
          <div className="flex h-full flex-1 flex-col gap-4 rounded-xl md:flex-row md:gap-8">
            ...
            <ImageInput
              ...
              className="aspect-auto min-h-[200px] rounded-xl dark:bg-transparent md:min-h-[200px]"
          ...
          <DialogFooter className="mb-2 mt-4 flex flex-row-reverse sm:justify-end">
            <DeleteQuizAlertDialog quizId={quiz.id} />
            <DialogClose asChild>
